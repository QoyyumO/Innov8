...
3. **Patient portal (INN-46).** Sign out. Sign in as `chioma@patient.innov8.ng`. The home dashboard shows PAT-002391 identity, home facility (FMC Lagos), and a bounded list of access events that name her. Clinician accounts do not see this view.
