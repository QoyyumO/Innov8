...
| [INN-56-audit-patient-searches-no-results](features/INN-56-audit-patient-searches-no-results/PLAN.md) | Audit patient searches that reach an index, hit or miss | In review ([#27](https://github.com/QoyyumO/Innov8/pull/27)) — narrows [#24](https://github.com/QoyyumO/Innov8/pull/24), which audited every non-empty query |
| [INN-57-login-must-not-reseed-demo-users](features/INN-57-login-must-not-reseed-demo-users/PLAN.md) | Public login must not re-seed demo users | In progress |
