...
| [INN-82-case-insensitive-patient-public-id](features/INN-82-case-insensitive-patient-public-id/PLAN.md) | Document case-insensitive patient public ID search | In review ([#51](https://github.com/QoyyumO/Innov8/pull/51)) |
