...
| [INN-80-lab-results-existence](features/INN-80-lab-results-existence/PLAN.md) | Lab results existence on index + authorised summary | In review ([#49](https://github.com/QoyyumO/Innov8/pull/49)) |
