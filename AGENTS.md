...
**Next:** [INN-66](https://linear.app/innov8-health/issue/INN-66) harden `verifyPassword` (this branch). Do **not** revive canceled tickets INN-5–INN-17 or INN-34; file new Innov8 issues. Check Linear for the current assignee before starting a ticket.
