...
import { isAdmin, isSecurityOfficer } from "@/services/permissions";
  ...
  return (
    <div>
      ...
      <ComponentCard
        ...
        desc="Every blocked access request raises a high-severity alert. Acknowledge while you investigate; close when resolved. Alerts are never deleted."
      >
